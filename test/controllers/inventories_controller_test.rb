...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { product: @inventory.product, quantity: @inventory.quantity, restaurant_id: @inventory.restaurant_id }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { product: @inventory.product, quantity: @inventory.quantity, restaurant_id: @inventory.restaurant_id }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
