...
class SpecialsControllerTest < ActionController::TestCase
  ...
  test "should create special" do
    assert_difference('Special.count') do
      post :create, special: { picture: @special.picture, restaurant_id: @special.restaurant_id, sdate: @special.sdate, special: @special.special, title: @special.title }
    end
  ...
  test "should update special" do
    patch :update, id: @special, special: { picture: @special.picture, restaurant_id: @special.restaurant_id, sdate: @special.sdate, special: @special.special, title: @special.title }
    assert_redirected_to special_path(assigns(:special))
  end
