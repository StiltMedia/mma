!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.jgrid.hasOwnProperty("regional") || (a.jgrid.regional = []), a.jgrid.regional["sr-latin"] = {
        defaults: {
        ...
        view: {caption: "Pogledaj zapis", bClose: "Zatvori"},
        del: {caption: "Izbrisi", msg: "Izbrisi izabran(e) zapise(e)?", bSubmit: "Izbriši", bCancel: "Odbaci"},
        nav: {
            edittext: "",
        ...
        col: {caption: "Izaberi kolone", bSubmit: "OK", bCancel: "Odbaci"},
        errors: {
            errcap: "Greška",
