!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.jgrid.hasOwnProperty("regional") || (a.jgrid.regional = []), a.jgrid.regional.vi = {
        defaults: {
        ...
        view: {caption: "Xem bản ghi", bClose: "Đóng"},
        del: {caption: "Xóa", msg: "Xóa bản ghi đã chọn?", bSubmit: "Xóa", bCancel: "Hủy bỏ"},
        nav: {
            edittext: "",
        ...
        col: {caption: "Chọn cột", bSubmit: "OK", bCancel: "Hủy bỏ"},
        errors: {
            errcap: "Lỗi",
