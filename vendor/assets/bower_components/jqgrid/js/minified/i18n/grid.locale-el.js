!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.jgrid.hasOwnProperty("regional") || (a.jgrid.regional = []), a.jgrid.regional.el = {
        defaults: {
        ...
        del: {caption: "Διαγραφή", msg: "Διαγραφή των επιλεγμένων εγγραφών;", bSubmit: "Ναι", bCancel: "Άκυρο"},
        nav: {
            edittext: " ",
        ...
        col: {caption: "Εμφάνιση / Απόκρυψη Στηλών", bSubmit: "ΟΚ", bCancel: "Άκυρο"},
        errors: {
            errcap: "Σφάλμα",
        ...
        formatter: {
            ...
            date: {
                ...
                AmPm: ["πμ", "μμ", "ΠΜ", "ΜΜ"],
                S: function (a) {
                    return 1 == a || a > 1 ? ["η"][Math.min((a - 1) % 10, 3)] : ""
                },
                srcformat: "Y-m-d",
                newformat: "d/m/Y",
                parseRe: /[#%\\\/:_;.,\t\s-]/,
