!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.jgrid.hasOwnProperty("regional") || (a.jgrid.regional = []), a.jgrid.regional.gl = {
        defaults: {
        ...
        view: {caption: "Consultar rexistro", bClose: "Pechar"},
        del: {
            caption: "Eliminar",
        ...
        col: {caption: "Mostrar/ocultar columnas", bSubmit: "Enviar", bCancel: "Cancelar"},
        errors: {
            errcap: "Erro",
