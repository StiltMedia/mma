!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.jgrid.hasOwnProperty("regional") || (a.jgrid.regional = []), a.jgrid.regional.no = {
        defaults: {
        ...
        search: {
            ...
            odata: [{oper: "eq", text: "lik"}, {oper: "ne", text: "forskjellig fra"}, {
                oper: "lt",
                text: "mindre enn"
            }, {oper: "le", text: "mindre eller lik"}, {oper: "gt", text: "større enn"}, {
                oper: "ge",
                text: " større eller lik"
