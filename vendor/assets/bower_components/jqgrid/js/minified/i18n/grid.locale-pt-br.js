!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.jgrid.hasOwnProperty("regional") || (a.jgrid.regional = []), a.jgrid.regional["pt-br"] = {
        defaults: {
        ...
        view: {caption: "Ver Registro", bClose: "Fechar"},
        del: {caption: "Apagar", msg: "Apagar registro(s) selecionado(s)?", bSubmit: "Apagar", bCancel: "Cancelar"},
        nav: {
            edittext: " ",
        ...
        col: {caption: "Mostrar/Esconder Colunas", bSubmit: "Enviar", bCancel: "Cancelar"},
        errors: {
            errcap: "Erro",
        ...
        formatter: {
            ...
            date: {
                ...
                AmPm: ["am", "pm", "AM", "PM"],
                S: function (a) {
                    return 11 > a || a > 13 ? ["º", "º", "º", "º"][Math.min((a - 1) % 10, 3)] : "º"
                },
                srcformat: "Y-m-d",
                newformat: "d/m/Y",
                parseRe: /[#%\\\/:_;.,\t\s-]/,
