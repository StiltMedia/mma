!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.jgrid.hasOwnProperty("regional") || (a.jgrid.regional = []), a.jgrid.regional.de = {
        defaults: {
        ...
        view: {caption: "Datensatz anzeigen", bClose: "Schließen"},
        ...
        col: {caption: "Spalten auswählen", bSubmit: "Speichern", bCancel: "Abbrechen"},
        errors: {
            errcap: "Fehler",
