!function (a) {
    ...
    a.jgrid = a.jgrid || {}, a.jgrid.hasOwnProperty("regional") || (a.jgrid.regional = []), a.jgrid.regional.ca = {
        defaults: {
        ...
        view: {caption: "Veure registre", bClose: "Tancar"},
        del: {
            caption: "Eliminar",
        ...
        col: {caption: "Mostrar/ocultar columnes", bSubmit: "Enviar", bCancel: "Cancelar"},
        errors: {
            errcap: "Error",
